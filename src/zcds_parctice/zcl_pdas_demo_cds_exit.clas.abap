CLASS zcl_pdas_demo_cds_exit DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_pdas_demo_cds_exit IMPLEMENTATION.
  METHOD if_sadl_exit_calc_element_read~calculate.

  DATA:
      lt_view_data TYPE STANDARD TABLE OF ZCAS_C_ITEM_PRICE_PER_UNIT WITH EMPTY KEY .
